  ...
  return (
    <div className="flex h-screen w-full bg-slate-50 overflow-hidden font-sans text-slate-900">
      ...
      <div
        ...
        } w-full md:w-80 bg-white border-r border-slate-200 flex-col z-20 shadow-xl h-full shrink-0`}
      >
              ...
              <div className="flex justify-between mb-2">
                <span
                  className={`px-2 py-0.5 rounded text-[8px] font-black uppercase ${
                    STATUS_MAP[item.status]?.color || "bg-slate-100"
                  }`}
                >
      ...
      <div
        ...
        } flex-1 flex-col h-full overflow-hidden relative bg-slate-50`}
      >
              ...
              <div className="flex gap-1 mb-8 border-b pb-1 overflow-x-auto">
                {TABS.map((t) => (
                  <button
                    ...
                    className={`px-6 py-3 text-xs font-bold uppercase border-b-2 transition-all flex gap-2 items-center whitespace-nowrap ${
                      activeTab === t.id
