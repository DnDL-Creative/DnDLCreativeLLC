        ...
        <div className="grid grid-cols-3 gap-3 mb-8">
          {[0, 50, 100].map((amt) => (
            <button
              ...
              className={`py-3 rounded-xl text-xs font-bold border-2 ${
                refundAmount === amt
    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-slate-900/50 backdrop-blur-sm">
      <div className="bg-white rounded-2xl shadow-2xl p-6 max-w-sm w-full border border-slate-100">
        ...
        <div className="flex gap-3">
          ...
          <button
            onClick={onConfirm}
            className={`flex-1 py-3 text-white rounded-xl text-xs font-bold uppercase shadow-lg ${
              isHolding
                ? "bg-blue-600"
                : isProduction
                ? "bg-emerald-600"
                ...
                <div className="flex flex-col lg:flex-row gap-6 md:gap-8 mb-6 pb-6 border-b border-slate-100">
                  ...
                  <div className="flex flex-row lg:flex-col gap-4 lg:w-40 lg:shrink-0">
                    ...
                    <div className="flex flex-col justify-center lg:hidden">
                      <span
                        className={`px-2 py-0.5 rounded-md text-[8px] font-black uppercase tracking-widest w-fit mb-1 ${
                          isRoster
                    ...
                    <div>
                      ...
                      <div className="flex flex-wrap gap-2 mb-4">
                        ...
                        <button
                          ...
                          className={`px-4 py-1.5 rounded-lg text-[9px] font-black uppercase tracking-widest border flex items-center gap-2 transition-all ${
                            isFinanceOpen
                        ...
                        <a
                          ...
                          target="_blank"
                          className={`px-4 py-1.5 rounded-lg text-[9px] font-black uppercase tracking-widest border flex items-center gap-2 ${
