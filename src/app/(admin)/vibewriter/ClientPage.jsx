...
// --- IMPORTS ---
import VibeEditor from "@/app/(admin)/vibewriter/_components/editor/VibeEditor";
import VibeImageStudio from "@/app/(admin)/vibewriter/_components/studio/ImageStudio";
import AssetSidebar from "@/app/(admin)/vibewriter/_components/sidebar/AssetSidebar";
import PopulateMeta from "@/app/(admin)/vibewriter/_components/meta/PopulateMeta";
import MeteorologicalEffect from "@/app/(admin)/vibewriter/_components/effects/MeteorologicalEffect";
import VibeTunes from "@/app/(admin)/vibewriter/_components/sidebar/VibeTunes";

const DystopianSnow = dynamic(
  () => import("@/app/(admin)/vibewriter/_components/effects/DystopianTheme"),
...
export default function ClientVibeWriter({ initialDrafts }) {
  ...
  const generateAndShowSql = () => {
    ...
    const sql =
      `INSERT INTO posts (title, slug, date, author, tag, image, image_2, image_3, image_4, image_5, image_6, image_caption, music_embed, blogcast_url, content, published) VALUES ('${escape(
        title
